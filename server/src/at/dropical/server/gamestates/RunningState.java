...
public class RunningState implements State {
    ...
    @Override
    public void handleInput(OnePlayer player, InputDataContainer inputDataContainer) {
        ...
        switch(action) {
            ...
            case UP: player.rotateLeft(); break;

            case DOWN: player.moveDown(); break;
            case DROP: player.dropTetromino(); break;

            case START: break; //TODO
            case PAUSE: break; //TODO
