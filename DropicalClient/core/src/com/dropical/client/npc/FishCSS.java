...
import com.dropical.client.world.FishRecorder;

public class FishCSS extends Sprite {
    private World world;
    private Body body;
    ...
    private FishRecorder fishRecorder = new FishRecorder("fish");

    //----------------------------------------

    public FishCSS(World world, String name, float x, float y) {
...
//        fishRecorder.addKeyframe(getX(), getY());
        fishRecorder.addKeyframe(getX(), getY(), "fish" + getRegionX()/14 + ".png");
    }
...
//                        swimNW();
        ...
        if(time == 3600) {
//            System.out.println(fishRecorder.buildString());
            fishRecorder.buildCSS();
        }
    ...
    private void swimNO() {
        body.applyLinearImpulse(20f, 20f, body.getPosition().x, body.getPosition().y, true);
        setRegion(currentFishTexture[0][4]);
    }
    private void swimRight() {
        body.applyLinearImpulse(20f, 0, body.getPosition().x, body.getPosition().y, true);
